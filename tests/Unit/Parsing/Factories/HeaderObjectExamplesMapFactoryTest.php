...
use TypeSlow\OpenApiParser\Parsing\Factories\HeaderObjectExamplesMapFactory;
...
#[CoversClass(HeaderObjectExamplesMap::class)]
#[CoversClass(HeaderObjectExamplesMapFactory::class)]
final class HeaderObjectExamplesMapFactoryTest extends TestCase
{
    ...
    {
        return HeaderObjectExamplesMapFactory::class;
    }

    public static function mapClass(): string
    {
        return HeaderObjectExamplesMap::class;
    }
    ...
    public static function examples(): iterable
    {
        yield 'example object example' => [
            ...
            'expected' => new HeaderObjectExamplesMap(items: (object) [
